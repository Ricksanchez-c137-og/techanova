export default function About() {
    return (
      <div className="space-y-8">
        <h1 className="text-4xl font-bold">About Hosn</h1>
        <p className="text-xl">Hosn is a leading IT solutions provider, dedicated to empowering businesses through innovative technology.</p>
        <section>
